...
#                                                                                                                                                       
# In this tool all are self explantory except below ones                                                                                                
# 1) Service check                                                                                                                                       
# 2) Check Process                                                                                                                                      
# 3) Port check  #                                                                                                                                       
# 4) Search Event logs                                                                                                                                  
...
$Form.Text = "Server Healthcheck for Server App KL Team by mohdzain.hassan@aig.com" 
$Form.TopMost = $true 
$Form.Width = 900 
$Form.Height = 700 
...
$label3.Text = "Enter List of Servers Below" 
...
$Filters.Text = "Enter Parameters to Filter" 
...
$Eventlb.Text = "Search Event Logs" 
...
$applicationbutton.Text = "App Logs" 
...
$Pingbutton.Width = 150
$Pingbutton.Height = 22 
$Pingbutton.location = new-object system.drawing.point($firstColumn,21) 
...
$Upbutton.Width = 150
$Upbutton.Height = 22 
$Upbutton.location = new-object system.drawing.point($firstColumn,50) 
...
$Serbutton.Text = "Service Check" 
$Serbutton.Width = 150 
$Serbutton.Height = 22 
$Serbutton.location = new-object system.drawing.point($firstColumn,80) 
...
$Listservicebutton.Width = 150
$Listservicebutton.Height = 22 
$Listservicebutton.location = new-object system.drawing.point($firstColumn,110) 
...
$InstalledAppsbutton.Text = "Installed Apps" 
$InstalledAppsbutton.Width = 150 
$InstalledAppsbutton.Height = 22 
$InstalledAppsbutton.location = new-object system.drawing.point($firstColumn,140) 
...
# 
# Below are second row, starts from pixel 500
#
...
$diskbutton.Width = 150
$diskbutton.Height = 22 
$diskbutton.location = new-object system.drawing.point($secondColumn,21) 
...
$cpubutton.Width = 150
$cpubutton.Height = 22 
$cpubutton.location = new-object system.drawing.point($secondColumn,50) 
...
$Membutton.Text = "Memory Usage" 
$Membutton.Width = 150
$Membutton.Height = 22 
$Membutton.location = new-object system.drawing.point($secondColumn,80) 
...
$LAdminbutton.Width = 150 
$LAdminbutton.Height = 22 
$LAdminbutton.location = new-object system.drawing.point($secondColumn,110) 
...
$HWSbutton.Width = 150 
$HWSbutton.Height = 22 
$HWSbutton.location = new-object system.drawing.point($secondColumn,140) 
$HWSbutton.Font = "Microsoft Sans Serif,8" 
...
#
# Display third column start at 700
#

 
$OSVbutton = New-Object system.windows.Forms.Button 
$OSVbutton.BackColor = "#5bd22c" 
$OSVbutton.Text = "Os Version" 
$OSVbutton.Width = 150
$OSVbutton.Height = 22 
$OSVbutton.location = new-object system.drawing.point($thirdColumn,21) 
...
$Process.Width = 150
$Process.Height = 22 
$Process.location = new-object system.drawing.point($thirdColumn,50) 
...
$portbutton.Width = 150 
$portbutton.Height = 22 
$portbutton.location = new-object system.drawing.point($thirdColumn,80) 
...
$Hotfixbutton.Width = 150 
$Hotfixbutton.Height = 22 
$Hotfixbutton.location = new-object system.drawing.point($thirdColumn,110) 
...
$exitbutton.location = new-object system.drawing.point($thirdColumn,140) 
...
{ 
   ...
   { 
      ...
      foreach ($app in $win32_product){ 
         ...
         Write-Output $applications | Select-Object Computername,HotFixID ,InstalledBy, InstalledOn | Sort InstalledOn -Descending
  ...
  if(Test-Connection -ComputerName $Computer -Count 1 -ea 0) { 
   try { 
    $Networks = Get-WmiObject Win32_NetworkAdapterConfiguration   -ComputerName   $Computer -EA Stop | ? {$_.IPEnabled} 
        ...
        Write-Warning "Error occurred while checking the server : $computer." 
        Continue 
   } 
